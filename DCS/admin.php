      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Nhóm 2</span>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="downloadReport.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Download report</a>
          </div>
          <!-- End of Page Heading -->
        ...
        <!-- Content Row -->
            <!-- row1 -->
            <h1 class="h5 mb-0 text-gray-900 align-center">line1 <a href="line1.php">chi tiết</a>
            <div class="row">
                                                                <!-- may1 -->
              ...
              <!-- row2 -->
            <h1 class="h5 mb-0 text-gray-900 align-center">line2 <a href="line2.php">chi tiết</a>
            <div class="row">
                                                                <!-- may1 (nam dinh)-->
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
