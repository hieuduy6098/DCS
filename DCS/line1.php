  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Content Row -->
        <h1 class="h5 mb-0 text-gray-900 align-center">line 1 <button data-toggle="collapse" data-target="#demo" class="btn btn-primary">cài đặt thông số</button>
            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">May 1.1
                    </h1>
                            ...
                            <table class="table">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="hieusuatM1L1"></div>
                                  </td>
                                </tr>
                                                        <!-- operation vsfb(Valve_speed)-->
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="sanLuongM1L1"></div>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="soGoiBiCanM1L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="ptgoiBiCanM1L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="soGoiRongM1L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="ptgoiRongM1L1"></div>
                                  </td>
                                </tr>
                              </tbody>
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">May 1.2
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="hieusuatM2L1"></div>
                                  </td>
                                </tr>
                                                        <!-- operation vsfb(Valve_speed)-->
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="sanLuongM2L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="soGoiBiCanM2L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="ptgoiBiCanM2L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="soGoiRongM2L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="ptgoiRongM2L1"></div>
                                  </td>
                                </tr>
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">May 1.3
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="hieusuatM3L1"></div>
                                  </td>
                                </tr>
                                                        <!-- operation vsfb(Valve_speed)-->
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="sanLuongM3L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="soGoiBiCanM3L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="ptgoiBiCanM3L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="soGoiRongM3L1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="ptgoiRongM3L1"></div>
                                  </td>
                                </tr>
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Line 1
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="tonghieusuatL1"></div>
                                  </td>
                                </tr>
                                                        <!-- operation vsfb(Valve_speed)-->
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="tongsanLuongL1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="tongsoGoiBiCanL1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="tongptgoiBiCanL1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="tongsoGoiRongL1"></div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="tongptgoiRongL1"></div>
                                  </td>
                                </tr>
